...
namespace InteractivePetSimulator
{
    public static class ItemDatabase
    {
        public static List<Item> Items = new List<Item>
        {
            ...
            new Item("Dog Food ( Bones )", ItemType.Food, 20, 25, 3, new List<PetType>{ PetType.Dog }),
            ...
            new Item("Ball", ItemType.Toy, 25, 15, 2, new List<PetType>{ PetType.Dog, PetType.Cat, PetType.Gecko, PetType.MiniDragon }),
            new Item("Plastic Toy", ItemType.Toy, 30, 20, 2, new List<PetType>{ PetType.Dog, PetType.Cat, PetType.Gecko, PetType.Snake }),
            new Item("Plush Toy", ItemType.Toy, 20, 10, 2, new List<PetType>{ PetType.Dog, PetType.Cat, PetType.Snake }),
            new Item("Soft Bed", ItemType.Bed, 50, 30, 5, new List<PetType>{ PetType.Dog, PetType.Cat, PetType.MiniDragon, PetType.Gecko, PetType.Snake, PetType.Turtle }),
            ...
            new Item("Heater", ItemType.Bed, 10, 15, 3, new List<PetType>{ PetType.Dog, PetType.Cat, PetType.Snake, PetType.Gecko })
        };
    }
}